	...
	<body>
		<header>
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3">
				<div class="container-fluid">
					<a class="navbar-brand" href="index.html" style = "margin-right: 250px; margin-left: 50px; font-size: 20px;">LOGO</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0" ">
							<li class="nav-item">
							    <a class="nav-link active " aria-current="page" href="index.html"style=" font-size: 20px; margin-right: 500px;">Home</a>
							</li>
						</ul>
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0" style = "margin-right: 75px;">
							<li class="nav-item">
							    <a class="nav-link active " aria-current="page" href="#" style="margin-right:50px;font-size: 20px;">Cart</a>
							</li>
							<div id = "avatar"></div>
		...
		<h2 class = "title">Popular Items</h2>
			...
			<div class = "row">
				<div class = "col-4">
				<img src = "assets/img/water.png" >
				<a href="itemPage.html"><h4>Water Bottle</h4></a>
				<p>P50.00</p>
				</div>
			</div>
			<div class = "row">
