...
<html>
	...
	<body>
		...
		<br><br>
		<div align ="LEFT">
			<h4><a href="userhomepage.html">Home</a>><a href="cart.php">Cart</a>><a href="checkout.confirm.php">Confirm Checkout</a></h4>
			<h4>Confirm Items to Checkout</h4>
			<a href="cart.php"><button class="btn-back">Back</button></a>
			<a href="checkout-confirm.php"><button class="btn-checkout">Checkout</button></a>
		</div>
			<div align="center">
			<style>
				table, th, td {
