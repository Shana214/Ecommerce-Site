	...
	<body>
		...
		<div align ="LEFT">
			...
			<style>
				...
				<td style="background-color:#979797;"><h2>Username:</h2></td><td> <input type=text name=#></td>
				<td style="background-color:#979797;"><h2>First Name:</h2></td><td> <input type=text name=#></td>
				</tr>
				<tr>
				<td style="background-color:#979797;"><h2>Last Name:</h2></td><td> <input type=text name=#></td>
				<td style="background-color:#979797;"><h2>Middle Name:</h2></td><td> <input type=text name=#></td>
				<td style="background-color:#979797;"><h2>Birthdate:</h2></td><td> <input type=text name=#></td>
				</tr>
				</table>
				<br><br>
				...
				<td style="background-color:#979797;"><h2><b>name</b></h2></td>
				<td style="background-color:#979797;"><h2><b>Username</b></h2></td>
				<td style="background-color:#979797;"><h2><b>Contact No.</b></h2></td>
				</tr>
				...
				if ($result->num_rows > 0) {
					 ...
					 while($row = $result->fetch_assoc()) {
						echo "<tr><td>".$row["CustomerId"]."</td><td>".$row["CustomerName"]."</td><td>".$row["CustomerEmail"]."</td><td> ".$row["CustomerContactNo"]."</td></tr>";
					}
					echo "</table>";
					} else {
					  echo "0 results";
