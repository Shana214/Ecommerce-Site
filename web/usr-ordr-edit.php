	...
	<body>
		...
		<div>
			<div class = "breadcrumbs">
				<h4><a href="adminpage.html">Dashboard</a>><a href="user-orders.php">Customer's Orders</a>><a href="usr-ordr-edit.php">Edit</a></h4>
			</div>
			<h2 class = "cart-title">Edit Customer's Orders</h2>
			<div class = "admin-btn" style = "margin-right:70px;">
				
				<a href="user-orders.php"><button class="btn edit">Back</button></a>
				<a href="#"><button class="btn remove">Edit Order</button></a></br></br></br>
			</div>
		</div>
