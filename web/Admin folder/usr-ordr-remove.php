...
<html>
	...
	<body>
		...
		<br><br>
		<div align ="LEFT">
			<h4><a href="userhomepage.html">Dashboard</a>><a href="user-orders.php">User's Orders</a>><a href="usr-ordr-remove.php">Delete</a></h4>
			<h4>User's Orders</h4>
			<a href="user-orders.php"><button class="btn remove">Back</button></a>
			<a href="#"><button class="btn edit">Delete Order</button></a>
			<table>
			</table>
		</div>
			<div align="center">
