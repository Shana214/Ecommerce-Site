...
<div class = "cart">
		<div>
			<div class = "breadcrumbs">
				<h4><a href="adminpage.html">Dashboard</a>><a href="user-orders.php">Customer's Orders</a>><a href="usr-ordr-remove.php">Remove</a></h4>
			</div>
			<h2 class = "cart-title">Delete Customer's Orders</h2>
			<div class = "admin-btn" style = "margin-right:70px;">
				
				<a href="user-orders.php"><button class="btn back">Back</button></a>
				<a href="#"><button class="btn remove">Remove Order</button></a></br></br></br>
			</div>
		</div>
