...
<html>
	...
	<body>
		...
		<br><br>
		<div align ="LEFT">
			<h4><a href="admin-dashboard.html">Dashboard</a>><a href="order-mgmt.php">Order Management</a>><a href="order-mgmt.php">Delete</a></h4>
			<h4>Order Management(Delete)</h4>
			<a href="order-mgmt.php"><button class="btn remove">Back</button></a>
			<button class="btn edit">Delete Order</button>
			<table>
			</table>

			<?php
			include "db_conn.php"
			/*insert sql and code for fetch data and delete query*/
