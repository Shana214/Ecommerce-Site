...
<html>
	...
	<body>
		...
		<br><br>
		<div align ="LEFT">
			<h4><a href="adminpage.html">Dashboard</a>><a href="order-mgmt.php">Order Management</a>><a href="order-mgmt-edit.php">Edit</a></h4>
			<h4>Order Management(Edit)</h4>
			<a href="order-mgmt.php"><button class="btn remove">Back</button></a>
			<a href="#"><button class="btn edit">Edit Order</button></a>
			<table>
			</table>
		</div>
			<div align="center">
