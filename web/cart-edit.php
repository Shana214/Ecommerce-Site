	...
	<body>
		...
		<div>
			<div class = "breadcrumbs">
				<h4><a href="userhomepage.html">Home</a>><a href="cart.php">Cart</a>><a href="cart-edit.php">Edit Items</a></h4>
			</div>
			<h2 class = "cart-title">Edit Items</h2>
			<div class = "cart-buttons">
				<a href="cart.php"><button class="btn back">Back</button></a>
				<button class="btn edit">Update</button></br></br></br>

				<?php
				include "db_conn.php";
				/*insert sql from table "cart" and add update*/
				?>
