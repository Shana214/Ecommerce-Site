...
<html>
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0" style = "margin-right: 75px;">
							<li class="nav-item">
							    <a class="nav-link active " aria-current="page" href="#" style="margin-right:50px;">Cart</a>
							</li>
							<div id = "avatar"></div>
		...
		<br><br>
		<div align ="LEFT">
			<h4><a href="index.html">Home</a>><a href="cart.php">Cart</a>><a href="cart-checkout.php">Checkout Items</a></h4>
			<h4>Checkout Items</h4>
			<a href="cart.php"><button class="btn back">Back</button></a>
			<a href="#"><button class="btn remove">Checkout</button></a>
		</div>
			<div align="center">
			<style>
				table, th, td {
